...
class AutomationLogger:
    ...
    def _setup_loggers(self):
        ...
        self.main_logger = builtin_logging.getLogger('automation')
        self.main_logger.setLevel(builtin_logging.DEBUG)

        # Error logger
        self.error_logger = builtin_logging.getLogger('automation.errors')
        self.error_logger.setLevel(builtin_logging.ERROR)

        # Performance logger
        self.perf_logger = builtin_logging.getLogger('automation.performance')
        self.perf_logger.setLevel(builtin_logging.INFO)
    ...
    def _setup_file_handlers(self):
        ...
        main_formatter = builtin_logging.Formatter(
        ...
        error_formatter = builtin_logging.Formatter(
        ...
        perf_formatter = builtin_logging.Formatter(
    ...
    def _setup_console_handler(self):
        ...
        console_handler = builtin_logging.StreamHandler()
        console_handler.setLevel(builtin_logging.WARNING)
        console_formatter = builtin_logging.Formatter(
            '%(asctime)s - %(levelname)s - %(message)s'
        )
